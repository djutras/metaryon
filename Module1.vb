...
Public Module Module1
    ...
    '        ConnString = "Provider=Microsoft.Jet.OleDb.4.0;Data Source=" & sAppPath() & "Viiger.mdb"
    '    End Function
    ...
    '                Dim strt As String = Application.StartupPath()
    '                strt = strt & "\"
    '                s_pathOfApps = strt
    ...
    '                If Func_Add(s_urlToCount, sNo) = "stop" Then
    ...
    '    Function Func_Add(ByVal s_urlToCount, ByVal sNo) As String
    ...
    '        Try
    '            Dim mySelectQuery As String = "SELECT ShortURL, sCount FROM PAGECOUNTER where ShortURL ='" & Trim(s_urlToCount) & "'"
    ...
    '                Call Sub_UpdateCounter(s_keepString, i_pageCounter)

    '            Else

    '                If Len(s_urlToCount) > 0 Then
    '                    Dim myInsertQuery As String = "INSERT INTO PAGECOUNTER (ShortURL,Done)" _
    '                    & "Values ('" & s_urlToCount & "','" & Trim(sNo) & "')"
    ...
    '    Sub Sub_UpdateCounter(ByVal s_keepString, ByVal i_pageCounter)
    ...
    '                myInsertQuery = "Update PAGECOUNTER set sCount = '" & CStr(i_pageCounter) & "' where ShortURL = '" & s_keepString & "'"
    ...
    '                "UPDATE DNSFOUND SET Done='" & (s_Yes) & "' where ShortURL ='" & (s_shortUrl) & "' "
    ...
    '    Sub Sub_DeleteRecordsPageCounter()

    '        Try
    '            Dim myConnection As New OleDbConnection(ConnStringDNA())
    '            Dim myInsertQuery As String = "Delete from PAGECOUNTER"
    ...
    '            Dim mySelectQuery As String = "SELECT Count(*) as CountDNS FROM DNSFOUND where ShortURL ='" & s_shortUrl & "'"
    ...
    '                Dim myQuery As String = "SELECT TOP 1 IDCOUNTER, url, Datehour FROM URLFOUND where (Done = '" & s_no & "' or Done ='" & s_yes & "'  ) and (URL_PAGE = '" & s_no & "' or URL_PAGE = '" & s_nothing & "' or URL_PAGE = '" & s_stop & "') and DateHour >= #" & d_date & "# order by DateHour desc"
    ...
    '                        Dim myInsertQuery As String = "UPDATE URLFOUND SET Done= '" & (s_so) & "',URL_PAGE = '" & s_pageContent & "' WHERE IDCounter =" & i_idCounter & ""
    ...
    '                        Dim myInsertQuery As String = "UPDATE URLFOUND SET Done= '" & (s_sa) & "' WHERE IDCounter =" & i_idCounter & ""
    ...
    '                    Dim s_sa As String = "sa"
    '                    Dim myInsertQuery As String = "UPDATE URLFOUND SET Done= '" & (s_no) & "' WHERE Done= '" & (s_sa) & "' and DateHour >= #" & d_date & "#"
    ...
    '            Dim myConnectionString As String = "UPDATE DNSFOUND SET Done= '" & (s_yes) & "' WHERE ID =" & i_ID & ""
    '            Dim myCommand2 As New OleDbCommand(myConnectionString)
    '            myCommand2.Connection = objConn
    '            objConn.Open()
    '            myCommand2.ExecuteNonQuery()
